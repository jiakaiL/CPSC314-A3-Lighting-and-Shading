...
for (let i = 0; i < Part.COUNT; ++i) {
  ...
  floorTextures[i] = new THREE.ImageUtils.loadTexture('images/a.jpg');
...
var texture1 = new THREE.ImageUtils.loadTexture('images/b.jpg');
...
var textureMidUniform = {type: "t", value:texture1};
...
var bPhongMaterial = new THREE.ShaderMaterial({
  uniforms: {
    textureMidUniform: textureMidUniform
  },
});
